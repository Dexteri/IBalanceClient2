...
namespace LauncherConsole
{
    public class FtpClient
    {
        ...
        public void DownloadFile(string path, string fileName, string localPath)
        {
            ...
            FileStream downloadedFile = new FileStream(localPath + "\\" + fileName, FileMode.Create, FileAccess.ReadWrite);
